                                        ...
                                        <div class="card">
                                            <div class="card-header align-items-center d-flex">
                                                ...
                                                <div class="flex-shrink-0">
                                                    <a href="/ski/ski_new" type="button" class="btn btn-soft-info"><i class="ri-add-circle-line align-middle me-1"></i> New SKI</a>
                                                </div>
                                            </div><!-- end card header -->
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="hstack gap-3 fs-18">
                                                                            <a href="ski-new.html" target="_blank" type="button" class="link-primary"><i class="ri-eye-line"></i></a>
                                                                            <a data-bs-toggle="modal" data-bs-target=".history-ski" type="button" class="link-primary"><i class="ri-history-line"></i></a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td><img src="/assets/images/users/avatar-3.jpg" alt="" class="avatar-xs rounded-circle me-2">
                                                                        <a href="#javascript: void(0);" class="text-body fw-medium">Gabino Arthur Rajendra Mahatma</a>
                                                                    </td>
                                                                    <td class="fs-13 fw-medium">Periode 1 (2020)</td>
                                                                    <td>
                                                                        <!-- <h5><span class="badge badge-soft-success">FINAL</span></h5> -->
                                                                ...
                                                                <tr>
                                                                    <td><img src="/assets/images/users/avatar-8.jpg" alt="" class="avatar-xs rounded-circle me-2">
                                                                        <a href="#javascript: void(0);" class="text-body fw-medium">Adyatma Mahavir Bagaskara</a>
                                                                    </td>
                                                                    <td class="fs-13 fw-medium">Periode 1 (2020)</td>
                                                                    <td>
                                                                        <!-- <h5><span class="badge badge-soft-success">FINAL</span></h5> -->
                                                        ...
                                                        <table class="table align-middle mb-0">
                                                                ...
                                                                <tr>
                                                                    <th scope="col" style="width: 25px;">
                                                                        <div class="form-check">
                                                                            <input class="form-check-input" type="checkbox" onclick="javascript:checkAll(this)">
                                                                        </div>
                                                                    </th>
                                                                    <th scope="col" class="w-50">Nama</th>
                                                                    <th scope="col" class="">Tahun dan Periode</th>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="hstack gap-3 fs-18">
                                                                            <a href="ski-new.html" target="_blank" type="button" class="btn btn-sm btn-soft-info"><i class="ri-eye-line align-middle me-1"></i> View</a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                                <tr>
