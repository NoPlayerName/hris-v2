    ...
    <div class="app-menu navbar-menu">
        ...
        <div class="navbar-brand-box">
            ...
            <a href="index.html" class="logo logo-dark">
                ...
                <span class="logo-lg">
                    <img
                        src="/assets/images/logo-trans7.png"
                        alt=""
                        height="50"
                    />
                </span>
                ...
                <ul id="navbar-nav" class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="human-capital.html">
                            ...
                            <span data-key="t-apps">Human Capital</span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="recruitment.html">
                            ...
                            <span data-key="t-layouts">Recruitment</span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="clearance.html">
                            ...
                            <span data-key="t-authentication">Clearance</span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="training.html">
                            ...
                            <span data-key="t-pages">Training</span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="mpp.html">
                            ...
                            <span data-key="t-landing">MPP</span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="administrator.html">
                            ...
                            <span data-key="t-base-ui">Administrator</span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="presence.html">
                            ...
                            <span data-key="t-advance-ui">Presence</span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="cuti-online.html">
                            ...
                            <span data-key="t-widgets">Cuti Online</span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="request-form.html">
                            ...
                            <span data-key="t-forms">Request Form</span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        >
                            <i class="ri-layout-3-line"></i>
                            <span data-key="t-tables">SKI & PA</span>
                        </a>
                        <div id="ski-pa" class="collapse show menu-dropdown">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <Link
                                        :href="route('inertia.ski')"
                                        class="nav-link"
                                        data-key="t-ski"
                                ...
                                <li class="nav-item">
                                    <a
                                        href="ski-tracking.html"
                                        target="_blank"
                                        class="nav-link"
                                        data-key="t-ski-tracking"
                                        >SKI Tracking</a
                                    >
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a
                                        href="pa-tracking.html"
                                        target="_blank"
                                        class="nav-link"
                                        data-key="t-pa-tracking"
                                        >PA Tracking</a
                                    >
                                </li>
                                <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="reimbursement.html">
                            ...
                            <span data-key="t-charts">Reimbursement</span>
                        </a>
                    </li>
                </ul>
            </div>
